...
export class World {
  ...
  setupFloor() {
    this.studioFloorGroup = new THREE.Group();
    this.studioFloorGroup.name = 'StudioFloorGroup';
    ...
    this.studioFloorGroup.add(floor);
    ...
    this.studioFloorGroup.add(podium);
    ...
    this.studioFloorGroup.add(ring);

    this.scene.add(this.studioFloorGroup);
  }

  hideStudioElements() {
    if (this.studioFloorGroup) {
      this.studioFloorGroup.visible = false;
    }
    this.scene.background = new THREE.Color(0xb8d5f0); // Realistic natural sky
    this.scene.fog = new THREE.FogExp2(0xc8d6e5, 0.018); // Soft urban horizon fog
  }

  showStudioElements() {
    if (this.studioFloorGroup) {
      this.studioFloorGroup.visible = true;
    }
    this.scene.background = new THREE.Color(0xf5f7fa);
    this.scene.fog = new THREE.FogExp2(0xf5f7fa, 0.04);
  }
